...
class Library:
    ...
    def __init__(self,root):
        ...
        ButtonFrame=Frame(MainFrame, width=1350, height=50, padx=20, relief=RIDGE)
        ButtonFrame.pack(side=BOTTOM)

        FrameDetails=Frame(MainFrame, bd=20, width=1350, height=400, padx=20, relief=RIDGE)
        FrameDetails.pack(side=BOTTOM)

        DataFrame=Frame(FrameDetails, bd=20, width=800, height=300, padx=20, relief=RIDGE)
        ...
        DataFrameRIGHT=LabelFrame(DataFrame, bd=10, width=400, height=300, padx=20, relief=RIDGE
        ...
        self.cboMemberType=ttk.Combobox(DataFrameLEFT, state='readonly',
                                        font=('arial', 12, 'bold'), width=23)
        self.cboMemberType['value']=('Admin Staff', 'Student', 'Lecturer')
